...
int main() {
    ...
    printf("Dharshini's public key: %lld\n", publicKeyA);
...
## Output:
<img width="1451" height="916" alt="image" src="https://github.com/user-attachments/assets/064995d2-8cd0-43a4-823a-6d22ac2f4335" />
